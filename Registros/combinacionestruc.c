 ...
 * @date 2021-02-06
/* Programa ejemplo de combinacion de estructuras de datos: Definición de nuevos tipos de datos (array de registros jerárquicos)    */
...
void leerFichasAlumnos(tipo_tabla tabla, int *n)
{
    ...
    while ((*n < Max_alumnos) && (c == 'S'))
    {
        ...
        do
        {
            printf("\tNumero de convocatorias: ");
