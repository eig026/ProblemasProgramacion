...
void escribir_centro_masas(tipo_vector m, tipo_vector x,
        tipo_vector y, tipo_vector z, int n);
void inicializar_vector(tipo_vector m, tipo_vector x,
                        tipo_vector y, tipo_vector z, int *n);
void grabar_archivo(tipo_vector m, tipo_vector x,
                        tipo_vector y, tipo_vector z, int n);
...
void grabar_archivo(tipo_vector m, tipo_vector x,
	...
	if(f==NULL){
		...
		for(i=0;i<n;++i){
			fprintf(f,"%10.2f %10.2f %10.2f %10.2f\n",m[i],x[i],y[i],z[i]);
		}
		fclose(f);
	}
}
